...
export default function Logo({color}:{color: string}) {
    return <div className="flex flex-col justify-center items-center">
        <div className="flex">
            <svg className="-mt-1 h-8 w-8" stroke={color?color:"currentColor"} fill={color?color:"currentColor"}  strokeWidth="0" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="font-bold text-white text-2xl">Recipe</div>
        </div>
        <Link href={'https://dovanminhan.com'} target="blank" className="opacity-80 italic text-xs -mt-1 -mr-9">by An Do</Link>
    </div>
}